(() => {
    ...
    app.config(['$mdThemingProvider', 'TIPOS_RESERVA', 'COR_RESERVA_PASSADA', function ($mdThemingProvider, TIPOS_RESERVA, COR_RESERVA_PASSADA) {
        ...
        $mdThemingProvider.theme(COR_RESERVA_PASSADA.mdTheme)
