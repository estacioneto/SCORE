(() => {
    ...
    angular.module("calendarioModulo", []).controller("CalendarioController", ['$scope', '$compile', '$filter', '$state', 'uiCalendarConfig', 'APP_STATES',
        ...
        function ($scope, $compile, $filter, $state, uiCalendarConfig, APP_STATES, Reserva, reservas, DataManipuladorService, LocaisService, ModalService) {
            ...
            this.criarReserva = (data) => {
                return ModalService.verReserva(new Reserva({
            ...
            this.visualizarAuditorio = function () {
                $state.go(APP_STATES.LOCAL_ID_INFO.nome, {
                    idLocal: self.local._id
                });
            };
