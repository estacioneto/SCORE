    ...
    module.exports = function (config) {
        config.set({
            ...
            files: [
                ...
                './vendor/js/angular-jwt/angular-jwt.min.js',
                './vendor/js/angular-lock/angular-lock.min.js',
                './vendor/js/angular-sanitize/angular-sanitize.min.js',
                './vendor/js/angular-material-calendar/angular-material-calendar.min.js',
