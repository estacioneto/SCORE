...
(function () {
    ...
    /**
     * Realiza a persistência da reserva e em seguida as suas respectivas repetições.
     * 
     * @param {Reserva} reserva Reserva a ser persistida.
     * @param {Function} callback Callback a ser executado no final da operação.
     */
